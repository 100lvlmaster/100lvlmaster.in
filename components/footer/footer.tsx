...
export const Footer = (props) => {
  return (
    ...
    >
      <div className="grid md:grid-cols-3 items-center lg:gap-1 grid-cols-1 space-y-2">
        <Link href="/">
          <div className="flex items-center flex-row">
            <div></div>
            <span className="dark:text-gray-300 text-gray-600">{`Home`}</span>
          </div>
        </Link>
        <Link href="/about">
          <div className="flex  flex-row ">
            <span className="dark:text-gray-300 text-gray-600">{`About`}</span>
          </div>
        </Link>{" "}
        <Link href="/work">
          <div className="flex items-center flex-row">
            <span className="dark:text-gray-300 text-gray-600">{`Work`}</span>
          </div>
        </Link>
        <a
          rel="noreferrer"
        ...
        >
          <div className="flex flex-row items-center space-x-2">
            ...
            <span className="dark:text-gray-300 text-gray-600">{`Discord`}</span>
          </div>
        </a>
        <a
          rel="noreferrer"
        ...
        >
          <div className="flex flex-row items-center space-x-2">
            ...
            <span className="dark:text-gray-300 text-gray-600">Github</span>
          </div>
        </a>{" "}
        <a rel="noreferrer" href="mailto: navinkodag@gmail.com" target="_blank">
          <div className="flex flex-row items-center space-x-2">
            <svg
              width="24"
              height="24"
            ...
            <span className="dark:text-gray-300 text-gray-600">Gmail</span>
          </div>
        </a>
        <a
          rel="noreferrer"
        ...
        >
          <div className="flex flex-row items-center space-x-2">
            ...
            <span className="dark:text-gray-300 text-gray-600">{`LinkedIn`}</span>
          </div>
        </a>
        <a
          rel="noreferrer"
        ...
        >
          <div className="flex flex-row items-center space-x-2">
            ...
            <span className="dark:text-gray-300 text-gray-600">{`Medium`}</span>
          </div>
        </a>
        <a
          target="_blank"
        ...
        >
          <div className="flex flex-row items-center space-x-2">
            ...
            <span className="dark:text-gray-300 text-gray-600">{`Youtube`}</span>
          </div>
        </a>
      </div>
